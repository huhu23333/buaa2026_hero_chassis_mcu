...
void UI_PushUp_Graphs(u8 cnt, void *Graphs)
{
   ...
   switch(cnt)
   {
      ...
      case 5:
         ...
         break;
      case 7:
         Graph->datahead.Data_ID=UI_Data_ID_Draw8;
         break;
      default:
         break;
   }
