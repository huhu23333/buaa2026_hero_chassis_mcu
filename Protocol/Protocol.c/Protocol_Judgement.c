...
// crc8 generator polynomial:G(x=x8+x5+x4+1
    ...
    static uint16_t wCRC_Table[256] =
        {
     ...
     */
    uint8_t Verify_CRC8_Check_Sum(unsigned char *pch_message, unsigned int dw_length)
    {
...
UI_Occupy_Data_t UI_Occupy_Data;
                ...
                if (Verify_CRC16_Check_Sum((judge_buf), judgeLen) == 1)
                {
                    ...
                    switch (g_referee.cmdID_)
                    {
                        ...
                        case ID_EVENT_DATA:
                            ...
                            UI_Occupy_Data.status_UL = (g_referee.event_data_.event_data >> 23) & 0x03;
                            break;
